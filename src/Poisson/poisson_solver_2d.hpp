...
class poisson_solver_2d : public FiniteElementP1System2d {
 ...
 public:
    poisson_solver_2d(mesh::mesh* p_mesh, std::size_t system_size, const physics::material_database& material_database)
        : FiniteElementP1System2d(p_mesh, system_size),
          m_material_database(material_database) {};

    void                   compute_stiffness_matrix() override;
    static Eigen::Vector3d compute_charge_density_elementary_second_member(
