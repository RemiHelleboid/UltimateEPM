...
class self_consistent_device_mmmc_simulation_2d : public PBMC::self_consistent_device_pbmc_simulation_base {
 public:
    ...
    [[nodiscard]] double      get_total_electron_weight() const;
    [[nodiscard]] double      get_total_hole_weight() const;
    ...
    void export_all_mmmc_trajectories_as_csv(const std::string& directory) const;
 ...
 private:
    ...
    fem::EigenSparseMatrix                  m_unconstrained_poisson_stiffness;
    ...
    [[nodiscard]] std::pair<double, double> compute_admc_ramo_current(bool restrict_to_probe = false) const;
