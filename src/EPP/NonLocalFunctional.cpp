...
//  * @param tau
//  */
// NonLocalFunctor::NonLocalFunctor(const NonLocalParameters& non_local_parameters, const epm_material& material, const
// Vector3D<double>& tau)
//     : m_non_local_parameters(non_local_parameters),
//       m_material(material),
//       m_tau(tau),
//       m_cinetic_factor{(uepm::constants::h_bar * uepm::constants::h_bar) / (2.0 * uepm::constants::m_e *
//       uepm::constants::q_e)}, m_fourrier_factor{2.0 * M_PI / m_material.get_lattice_constant_meter()},
//       m_V0_pref_factor(2.0 * M_PI / m_material.get_lattice_constant_meter()),
//       m_V2_square_well_pref_factor{m_V0_pref_factor},
//       m_V2_gaussian_well_pref_factor{pow(M_PI, 1.5) * (pow(m_non_local_parameters.m_R2_anion, 3.0) /
//       m_material.get_atomic_volume())} {}

// /**
//  * @brief Compute the so called F_l function, which is used in the non-local pseudopotential correction.
//  * (See Chelikowsky, J. R. & Cohen, M. L. Nonlocal pseudopotential calculations for the electronic structure of
//  eleven diamond
...
//  * @return double
//  */
// double NonLocalFunctorF_l_function(const Vector3D<double>& K1, const Vector3D<double>& K2, double atomic_radii, int
// l) {
...
//         * atomic_radii) -
//                          norm_K2 * generalized_bessel(l + 1, norm_K2 * atomic_radii) * generalized_bessel(l, norm_K1
//                          * atomic_radii);
//         return pre_factor * F;
...
//                          generalized_bessel(l - 1, norm_K1 * atomic_radii) * generalized_bessel(l + 1, norm_K1 *
//                          atomic_radii);
//         return pre_factor * F;
//     } else {
...
//     return bessel_2nd_order_first_kind(bessel_arg) * exp(-0.25 * (norm_K1 * norm_K1 + norm_K2 * norm_K2) *
//     atomic_radii * atomic_radii);
// }

// /**
//  * @brief Compute the non local correction to the EPM Hamiltonian.
//  * It follows: Chelikowsky, J. R. & Cohen, M. L. Nonlocal pseudopotential calculations for the electronic structure
//  of eleven diamond
//  * and zinc-blende semiconductors. Phys. Rev. B 14, 556–582 (1976).
...
//     uepm::constants::q_e); const double           fourier_factor    = 2.0 * M_PI / get_lattice_constant_meter();
...
//     double V_anion = 0;
//     // l = 0
//     const double A_0_anion = m_non_local_parameters.m_alpha_0_anion + diag_factor *
//     m_non_local_parameters.m_beta_0_anion *
//                                                                           (norm_K1 * norm_K2 -
//                                                                           pow(this->get_fermi_momentum(), 2.0));
//     const double F_0_anion = (m_non_local_parameters.m_R0_anion == 0.0) ? 0.0 : F_l_function(K1, K2,
//     m_non_local_parameters.m_R0_anion, 0); V_anion += V_pre_factor * A_0_anion * (2 * 0 + 1) * 1.0 * F_0_anion;
//     // l = 2
...
//     double V_cation = 0;
//     // l = 0
//     const double F_0_cation = (m_non_local_parameters.m_R0_cation == 0) ? 0.0 : F_l_function(K1, K2,
//     m_non_local_parameters.m_R0_cation, 0); const double A_0_cation = m_non_local_parameters.m_alpha_0_cation +
//     m_non_local_parameters.m_beta_0_cation * diag_factor *
//                                                                             (norm_K1 * norm_K2 -
//                                                                             pow(this->get_fermi_momentum(), 2.0));
...
//     return std::complex<double>(cos(const_two * M_PI * Gtau) * V_symmetric, sin(const_two * M_PI * Gtau) *
//     V_antisymmetric);
// }
...
// //     constexpr int l          = 0;
// //     const double  pre_factor = pow(atomic_radii, 2.0) / (norm_K1 * norm_K1 - norm_K2 * norm_K2);
// //     const double  F          = norm_K1 * generalized_bessel(l + 1, norm_K1 * atomic_radii) * generalized_bessel(l,
// norm_K2 * atomic_radii) -
// //                      norm_K2 * generalized_bessel(l + 1, norm_K2 * atomic_radii) * generalized_bessel(l, norm_K1 *
// atomic_radii);
// //     return m_V0_pref_factor * pre_factor * F;
// // }
...
// //                      generalized_bessel(l - 1, norm_K * atomic_radii) * generalized_bessel(l + 1, norm_K *
// atomic_radii);
...
// //     const double A_0_anion         = m_non_local_parameters.m_alpha_0_anion + m_cinetic_factor *
// m_non_local_parameters.m_beta_0_anion
// *
// //                                                                           (norm_K1 * norm_K2 -
...
// // std::complex<double> NonLocalFunctor::operator()(const Vector3D<double>& K1_normalized, const Vector3D<double>&
// K2_normalized) const {
// //     const Vector3D<double> G_diff_normalized           = K1_normalized - K2_normalized;
// //     const double           anion_non_local_correction  = compute_anion_non_local_correction(K1_normalized,
// K2_normalized);
// //     const double           cation_non_local_correction = compute_cation_non_local_correction(K1_normalized,
// K2_normalized);
