/**
 * @file amc_self_consistent_device_simulation_2d.cpp
...
void self_consistent_device_amc_simulation_2d::validate_self_consistent_options() const {
    if (m_dimension != 2) {
 ...
 *
 */
void self_consistent_device_amc_simulation_2d::initialize_contact_elements() {
...
void self_consistent_device_amc_simulation_2d::place_initial_charges_according_to_doping(double particle_weight) {
...
void self_consistent_device_amc_simulation_2d::reset_element_charges() {
    for (const auto& element : m_device.get_p_mesh()->get_list_bulk_element()) {
        element->reset_charge();
    }
}

void self_consistent_device_amc_simulation_2d::recompute_vertex_space_charge_from_element_charges(
    std::size_t accumulation_steps) {
    if (accumulation_steps == 0) {
        throw std::invalid_argument("accumulation_steps must be positive.");
    }
...
void self_consistent_device_amc_simulation_2d::apply_z_periodicity_to_particles() {
...
void self_consistent_device_amc_simulation_2d::run_self_consistent_transport_simulation() {
...
void self_consistent_device_amc_simulation_2d::export_current_state() { export_current_snapshot(); }
