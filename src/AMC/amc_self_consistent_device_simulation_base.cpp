...
void self_consistent_device_amc_simulation_base::advance_quench_circuit(double averaged_ramo_current_A,
                                                                        double dt_s,
...
void self_consistent_device_amc_simulation_base::update_successful_quench_detection(
    double      sample_time_s,
...
const avalanche_detection_state& self_consistent_device_amc_simulation_base::avalanche_detection() const {
