...
if __name__ == "__main__":
    ...
    h = 1.0
    mesh_size = 0.025
    #  CAD Factory for geometry


    gmsh.option.setNumber("Mesh.CharacteristicLengthMin", mesh_size)
    gmsh.option.setNumber("Mesh.CharacteristicLengthMax", mesh_size)
    gmsh.model.occ.addSphere(0.0, 0.0, 0.0, h)
    gmsh.model.occ.synchronize()
    gmsh.option.setNumber('Mesh.Algorithm3D', 1) # new algo
...
#     # Write to .msh
#     write_msh("delaunay_mesh_0.msh", points, tri.simplices)

#     # Load and visualize in Gmsh
#     gmsh.initialize()
#     gmsh.open("delaunay_mesh_0.msh")
...
#     # save the mesh
#     outname = "delaunay_mesh_refined.msh"
#     if len(sys.argv) > 2:
#         outname = sys.argv[2]
#     gmsh.write(outname)
